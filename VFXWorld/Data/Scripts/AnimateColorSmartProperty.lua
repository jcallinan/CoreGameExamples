...
local startVal = script:GetCustomProperty("StartColor")
local endVal = script:GetCustomProperty("EndColor")
...
function Tick(deltaTime)
	...
	script.parent:SetSmartProperty(propertyName, Color.Lerp(startVal, endVal, t)) 
