...
function Tick(deltaTime)
	...
	if propertyName == "Volume" then 
		script.parent.volume = CoreMath.Lerp(startVal, endVal, t)
	end
	if propertyName == "Pitch" then 
		script.parent.pitch = CoreMath.Lerp(startVal, endVal, t)
	end
