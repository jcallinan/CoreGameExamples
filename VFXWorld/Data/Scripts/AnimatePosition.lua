...
local startPosition = script:GetCustomProperty("StartPosition")
...
local triggerNextAnim = script:GetCustomProperty("StartAnotherAnimate") 
local scriptToTrigger = script:GetCustomProperty("ScriptToTrigger"):WaitForObject() 
...
function Tick(deltaTime)
	...
	script.parent:SetPosition(Vector3.Lerp(startPosition, endPosition, t)) 
